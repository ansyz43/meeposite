...
export default function Register() {
  ...
  function openTelegramAuth() {
    ...
    function handleAuth(tgUser) {
      ...
      setError('')
      setLoading(true)
      authRef.current.loginWithTelegram({ ...tgUser, ref_code: refCodeRef.current || undefined })
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 relative overflow-hidden bg-background">
      ...
      <div className="absolute bottom-[20%] right-[20%] w-[400px] h-[400px] bg-cyan-500/[0.06] rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="glass-card p-8">
          ...
          {refCode && (
            <div className="bg-sky-500/10 border border-sky-500/20 rounded-xl px-4 py-3 text-sky-400 text-sm mb-4 text-center">
          ...
          <p className="text-center text-white/40 text-sm mt-6">
            Уже есть аккаунт? <Link to="/login" className="text-sky-400 hover:underline">Войти</Link>
          </p>
        </div>
      </div>
    </div>
